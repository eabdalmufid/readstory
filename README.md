...
2. Masukkan nomor WhatsApp Anda dengan kode negara (contoh: `628123456789`)

3. Masukkan kode pairing yang muncul ke WhatsApp Anda:
   - Buka **Pengaturan** → **Perangkat Tertaut**
   - Ketuk **Tautkan Perangkat**
   - Pilih **Tautkan dengan nomor telepon**
   - Masukkan kode yang ditampilkan di terminal

4. Bot akan otomatis membaca semua story/status dari kontak Anda

### Perintah yang Tersedia

| Perintah | Deskripsi |
|----------|-----------|
| `.ping`, `#ping`, `!ping`, `/ping` | Cek waktu respons bot |

### Logout

Untuk logout atau mengganti akun:
```bash
rm -rf sessions
```